...
You can use the [editor on GitHub](https://github.com/mahatoashish/COVID-19/edit/main/docs/index.md) to maintain and preview the content for your website in Markdown files.
...
<p>Dakpathar is a year go around the place but monsoon and summer are the best suited months to observe the natural beauty of this small town.</p>
...
<p><a href="https://www.wander-world.org/single-post/2017/09/05/7-Days-in-Cape-Town?gclid=EAIaIQobChMI6ej0t9e54QIV0QorCh3fmwKNEAAYAyAAEgKf3PD_BwE">7 Days in Cape Town</a></p>
      ...
      <img src="7894.jpeg" width="80" height="52" />
...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/mahatoashish/COVID-19/settings). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
